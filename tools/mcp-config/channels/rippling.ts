/**
 * Rippling HRIS/payroll channel.
 *
 * Phase C: served as Streamable HTTP from a single VM-hosted bun process
 * (port 18816, fronted by Tailscale funnel at /rippling). Clients
...
export const rippling: ChannelDef = {
  name: "rippling",
  defaultLaunchStyle: "http",
  toolDirRel: "tools/rippling-mcp",
  entryFile: "server.ts",
  ...
  httpUrl: () => "https://claude-cloud.tail053faf.ts.net/rippling/mcp",
