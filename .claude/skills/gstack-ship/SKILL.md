...
```bash
bash ~/openclaw/config/claude/hooks/statusline-emit.sh skill-start "/ship" "Pre-flight" "Merge Base" "Tests" "Review" "Version Bump" "Changelog" "Commit" "Verify"
```
...
```bash
bash ~/openclaw/config/claude/hooks/statusline-emit.sh step-start "/ship" 1
```
...
```bash
bash ~/openclaw/config/claude/hooks/statusline-emit.sh step-done "/ship" 1
```

```bash
bash ~/openclaw/config/claude/hooks/statusline-emit.sh step-start "/ship" 2
```
...
```bash
bash ~/openclaw/config/claude/hooks/statusline-emit.sh step-done "/ship" 2
```

```bash
bash ~/openclaw/config/claude/hooks/statusline-emit.sh step-start "/ship" 3
```
...
```bash
bash ~/openclaw/config/claude/hooks/statusline-emit.sh step-done "/ship" 3
```

```bash
bash ~/openclaw/config/claude/hooks/statusline-emit.sh step-start "/ship" 4
```
...
```bash
bash ~/openclaw/config/claude/hooks/statusline-emit.sh step-done "/ship" 4
```

```bash
bash ~/openclaw/config/claude/hooks/statusline-emit.sh step-start "/ship" 5
```
...
```bash
bash ~/openclaw/config/claude/hooks/statusline-emit.sh step-done "/ship" 5
```

```bash
bash ~/openclaw/config/claude/hooks/statusline-emit.sh step-start "/ship" 6
```
...
```bash
bash ~/openclaw/config/claude/hooks/statusline-emit.sh step-done "/ship" 6
```

```bash
bash ~/openclaw/config/claude/hooks/statusline-emit.sh step-start "/ship" 7
```
...
```bash
bash ~/openclaw/config/claude/hooks/statusline-emit.sh step-done "/ship" 7
```

```bash
bash ~/openclaw/config/claude/hooks/statusline-emit.sh step-start "/ship" 8
```
...
```bash
bash ~/openclaw/config/claude/hooks/statusline-emit.sh step-done "/ship" 8
bash ~/openclaw/config/claude/hooks/statusline-emit.sh skill-done "/ship" success
```
