...
```bash
bash ~/openclaw/config/claude/hooks/statusline-emit.sh skill-start "/plan-ceo-review" "Scope Challenge" "Architecture" "Error/Security" "Data/Code" "Tests/Perf" "Deploy/Future"
```
...
```bash
bash ~/openclaw/config/claude/hooks/statusline-emit.sh step-start "/plan-ceo-review" 1
```
...
```bash
bash ~/openclaw/config/claude/hooks/statusline-emit.sh step-done "/plan-ceo-review" 1
```

## Review Sections (10 sections, after scope and mode are agreed)

```bash
bash ~/openclaw/config/claude/hooks/statusline-emit.sh step-start "/plan-ceo-review" 2
```
...
```bash
bash ~/openclaw/config/claude/hooks/statusline-emit.sh step-done "/plan-ceo-review" 2
```

```bash
bash ~/openclaw/config/claude/hooks/statusline-emit.sh step-start "/plan-ceo-review" 3
```
...
```bash
bash ~/openclaw/config/claude/hooks/statusline-emit.sh step-done "/plan-ceo-review" 3
```

```bash
bash ~/openclaw/config/claude/hooks/statusline-emit.sh step-start "/plan-ceo-review" 4
```
...
```bash
bash ~/openclaw/config/claude/hooks/statusline-emit.sh step-done "/plan-ceo-review" 4
```

```bash
bash ~/openclaw/config/claude/hooks/statusline-emit.sh step-start "/plan-ceo-review" 5
```
...
```bash
bash ~/openclaw/config/claude/hooks/statusline-emit.sh step-done "/plan-ceo-review" 5
```

```bash
bash ~/openclaw/config/claude/hooks/statusline-emit.sh step-start "/plan-ceo-review" 6
```
...
```bash
bash ~/openclaw/config/claude/hooks/statusline-emit.sh step-done "/plan-ceo-review" 6
bash ~/openclaw/config/claude/hooks/statusline-emit.sh skill-done "/plan-ceo-review" success
```
