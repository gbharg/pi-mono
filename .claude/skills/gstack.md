...
description: |
  ...
  When the user's request involves BOTH a workflow stage (e.g., PR review, debugging)
  AND browser QA testing, handle both: run the browse commands for QA AND suggest the
  relevant workflow skill. Do not ignore either aspect of a mixed request.
...
## SETUP (run this ONCE before any browse command — $B is not defined until you do)
...
- **Only use commands from the Command Reference below.** Do not invent or guess browse subcommands. If a capability is not listed, it does not exist.
...
<!-- OpenClaw child skill references (used by build-skills-index.mjs for parent/child detection) -->
<!-- ~/openclaw/skills/gstack:review/SKILL.md -->
<!-- ~/openclaw/skills/gstack:qa/SKILL.md -->
<!-- ~/openclaw/skills/gstack:browse/SKILL.md -->
<!-- ~/openclaw/skills/gstack:office-hours/SKILL.md -->
<!-- ~/openclaw/skills/gstack:plan-ceo-review/SKILL.md -->
<!-- ~/openclaw/skills/gstack:plan-eng-review/SKILL.md -->
<!-- ~/openclaw/skills/gstack:plan-design-review/SKILL.md -->
<!-- ~/openclaw/skills/gstack:design-consultation/SKILL.md -->
<!-- ~/openclaw/skills/gstack:design-review/SKILL.md -->
<!-- ~/openclaw/skills/gstack:investigate/SKILL.md -->
<!-- ~/openclaw/skills/gstack:ship/SKILL.md -->
<!-- ~/openclaw/skills/gstack:document-release/SKILL.md -->
<!-- ~/openclaw/skills/gstack:retro/SKILL.md -->
<!-- ~/openclaw/skills/gstack:qa-only/SKILL.md -->
<!-- ~/openclaw/skills/gstack:guard/SKILL.md -->
<!-- ~/openclaw/skills/gstack:gstack-upgrade/SKILL.md -->
