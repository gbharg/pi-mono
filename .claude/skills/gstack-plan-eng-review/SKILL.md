...
```bash
bash ~/openclaw/config/claude/hooks/statusline-emit.sh skill-start "/plan-eng-review" "Architecture" "Code Quality" "Tests" "Performance"
```

## Review Sections (after scope is agreed)

```bash
bash ~/openclaw/config/claude/hooks/statusline-emit.sh step-start "/plan-eng-review" 1
```
...
```bash
bash ~/openclaw/config/claude/hooks/statusline-emit.sh step-done "/plan-eng-review" 1
```

```bash
bash ~/openclaw/config/claude/hooks/statusline-emit.sh step-start "/plan-eng-review" 2
```
...
```bash
bash ~/openclaw/config/claude/hooks/statusline-emit.sh step-done "/plan-eng-review" 2
```

```bash
bash ~/openclaw/config/claude/hooks/statusline-emit.sh step-start "/plan-eng-review" 3
```
...
```bash
bash ~/openclaw/config/claude/hooks/statusline-emit.sh step-done "/plan-eng-review" 3
```

```bash
bash ~/openclaw/config/claude/hooks/statusline-emit.sh step-start "/plan-eng-review" 4
```
...
```bash
bash ~/openclaw/config/claude/hooks/statusline-emit.sh step-done "/plan-eng-review" 4
bash ~/openclaw/config/claude/hooks/statusline-emit.sh skill-done "/plan-eng-review" success
```
