...
```bash
bash ~/openclaw/config/claude/hooks/statusline-emit.sh skill-start "/plan-design-review" "Info Arch" "States" "Journey" "AI Slop" "Design Sys" "Responsive" "Decisions"
```
...
```bash
bash ~/openclaw/config/claude/hooks/statusline-emit.sh step-start "/plan-design-review" 1
```
...
```bash
bash ~/openclaw/config/claude/hooks/statusline-emit.sh step-done "/plan-design-review" 1
```

```bash
bash ~/openclaw/config/claude/hooks/statusline-emit.sh step-start "/plan-design-review" 2
```
...
```bash
bash ~/openclaw/config/claude/hooks/statusline-emit.sh step-done "/plan-design-review" 2
```

```bash
bash ~/openclaw/config/claude/hooks/statusline-emit.sh step-start "/plan-design-review" 3
```
...
```bash
bash ~/openclaw/config/claude/hooks/statusline-emit.sh step-done "/plan-design-review" 3
```

```bash
bash ~/openclaw/config/claude/hooks/statusline-emit.sh step-start "/plan-design-review" 4
```
...
```bash
bash ~/openclaw/config/claude/hooks/statusline-emit.sh step-done "/plan-design-review" 4
```

```bash
bash ~/openclaw/config/claude/hooks/statusline-emit.sh step-start "/plan-design-review" 5
```
...
```bash
bash ~/openclaw/config/claude/hooks/statusline-emit.sh step-done "/plan-design-review" 5
```

```bash
bash ~/openclaw/config/claude/hooks/statusline-emit.sh step-start "/plan-design-review" 6
```
...
```bash
bash ~/openclaw/config/claude/hooks/statusline-emit.sh step-done "/plan-design-review" 6
```

```bash
bash ~/openclaw/config/claude/hooks/statusline-emit.sh step-start "/plan-design-review" 7
```
...
```bash
bash ~/openclaw/config/claude/hooks/statusline-emit.sh step-done "/plan-design-review" 7
bash ~/openclaw/config/claude/hooks/statusline-emit.sh skill-done "/plan-design-review" success
```
